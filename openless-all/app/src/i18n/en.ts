...
export const en: typeof zhCN = {
  ...
  settings: {
    ...
    permissions: {
      ...
      androidNotificationKeepaliveLabel: 'Notification keep-alive',
      androidNotificationKeepaliveEnabled: 'Keep a persistent “Remote dictation standby” notification',
      androidNotificationKeepaliveHint: 'Recommended for remote dictation. Keeps the foreground service alive and restores the LAN server automatically when possible.',
      androidKeepaliveStatusLabel: 'Remote dictation keep-alive status',
      androidKeepaliveStatusHint: 'Last check: {{lastCheckAt}}',
      androidKeepaliveDiagHint: 'Service started {{restartCount}} times · last start {{lastServiceStartAt}} · last exit {{lastProcessDeathAt}}',
      androidKeepaliveRestart: 'Restart keep-alive service',
      androidKeepaliveSelfTest: 'Run keep-alive self-test',
      androidKeepaliveSelfTestKill: 'Process-kill restart test',
      androidKeepaliveSelfTestKillConfirm: 'This will immediately kill the app process; the system restarts the service and verifies LAN recovery. The current window will briefly disappear — continue?',
      androidKeepaliveSelfTestRecovered: 'Process-level test passed: LAN service automatically recovered after process death ({{recoveredAt}})',
      androidKeepaliveOpenNotification: 'Allow notifications',
      androidKeepaliveOpenBattery: 'Battery settings',
      androidKeepaliveRunning: 'Running',
      androidKeepaliveLanOnly: 'LAN server only',
      androidKeepaliveStopped: 'Stopped / error',
