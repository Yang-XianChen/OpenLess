...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    permissions: {
      ...
      androidSinglePixelKeepaliveLabel: '단일 픽셀 오버레이 유지',
      androidSinglePixelKeepaliveEnabled: '1×1 비대화형 오버레이를 활성화하여 프로세스 유지',
      androidSinglePixelKeepaliveHint: '오버레이 권한이 필요합니다. 표시되지 않고 상호작용도 불가능하며 앱 유지에만 사용됩니다.',
      androidNotificationKeepaliveLabel: '알림 상주',
      androidNotificationKeepaliveEnabled: '“원격 받아쓰기 대기 중” 알림을 상주시켜 포그라운드 서비스 유지',
      androidNotificationKeepaliveHint: '원격 받아쓰기에 권장됩니다. 서비스가 재시작되면 LAN 서버를 자동 복구하고, 실패 시 알림으로 해결 방법을 안내합니다.',
      androidKeepaliveStatusLabel: '원격 받아쓰기 상주 상태',
      androidKeepaliveStatusHint: '마지막 점검: {{lastCheckAt}}',
      androidKeepaliveDiagHint: '서비스 시작 {{restartCount}}회 · 마지막 시작 {{lastServiceStartAt}} · 마지막 종료 {{lastProcessDeathAt}}',
      androidKeepaliveRestart: '상주 서비스 다시 시작',
      androidKeepaliveSelfTest: '상주 자가 테스트 실행',
      androidKeepaliveSelfTestKill: '프로세스 강제 재시작 테스트',
      androidKeepaliveSelfTestKillConfirm: '앱 프로세스를 즉시 종료하고 시스템이 서비스를 재시작해 LAN 복구를 확인합니다. 현재 창이 잠시 사라집니다. 계속하시겠습니까?',
      androidKeepaliveSelfTestRecovered: '프로세스 수준 테스트 통과: 종료 후 LAN 서비스 자동 복구됨({{recoveredAt}})',
      androidKeepaliveOpenNotification: '알림 허용',
      androidKeepaliveOpenBattery: '배터리 설정',
      androidKeepaliveRunning: '실행 중',
      androidKeepaliveLanOnly: 'LAN 서버만 실행',
      androidKeepaliveStopped: '중지됨 / 오류',
      ...
      androidOverlayTrigger: { background: '백그라운드', keyboard: '키보드 표시 시', always: '항상', off: '끄기' },
      androidOverlayTriggerHint: { background: '단순', keyboard: '이 모드는 보류되었습니다. 기존 설정은 백그라운드로 되돌립니다.', always: '항상 표시', off: '받아쓰기 버튼을 완전히 숨깁니다. 단일 픽셀 유지 오버레이는 별도로 켤 수 있습니다.' },
